...
namespace ShareX.HelpersLib
{
    public static class URLHelpers
    {
        ...
        public static void DownloadFile(string url, string filePath)
        {
            ...
            {
                //TODO: FileHelpers.CreateDirectoryFromFilePath(filePath);

                using (WebClient wc = new WebClient())
                {
                    wc.Headers.Add(HttpRequestHeader.UserAgent, "UploderX");
        ...
        public static string DownloadString(string url, bool noCache = true)
        {
            ...
            if (!string.IsNullOrEmpty(url))
            {
                using (WebClient wc = new WebClient())
                {
                    ...
                    wc.Headers.Add(HttpRequestHeader.UserAgent, "UploaderX");
                    wc.Proxy = HelpersOptions.CurrentProxy.GetWebProxy();
